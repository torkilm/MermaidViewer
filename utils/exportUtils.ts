...
export const encodeDiagramToUrl = (
  code: string,
  title: string,
  viewMode?: string
): string => {
...
export const decodeDiagramFromUrl = (
  encoded: string
): { code: string; title: string; viewMode?: string } | null => {
  try {
...
export const getDiagramFromUrl = (): {
  code: string;
  title: string;
  viewMode?: string;
} | null => {
...
export const updateUrlWithDiagram = (
  code: string,
  title: string,
  viewMode?: string
): void => {
