  ...
  return (
    ...
    B --> C[Create Amazing Diagrams]`} blockId="flowchart-basic" />
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
              <div className="p-3 rounded-lg" style={{ backgroundColor: COLORS.primary.base }}>
                <p className="font-bold" style={{ color: COLORS.text.primary }}>TD/TB</p>
                <p className="text-xs md:text-sm" style={{ color: COLORS.text.muted }}>Top to Bottom</p>
              </div>
              <div className="p-3 rounded-lg" style={{ backgroundColor: COLORS.primary.base }}>
                <p className="font-bold" style={{ color: COLORS.text.primary }}>BT</p>
                <p className="text-xs md:text-sm" style={{ color: COLORS.text.muted }}>Bottom to Top</p>
              </div>
              <div className="p-3 rounded-lg" style={{ backgroundColor: COLORS.primary.base }}>
                <p className="font-bold" style={{ color: COLORS.text.primary }}>LR</p>
                <p className="text-xs md:text-sm" style={{ color: COLORS.text.muted }}>Left to Right</p>
              </div>
              <div className="p-3 rounded-lg" style={{ backgroundColor: COLORS.primary.base }}>
                <p className="font-bold" style={{ color: COLORS.text.primary }}>RL</p>
                <p className="text-xs md:text-sm" style={{ color: COLORS.text.muted }}>Right to Left</p>
              </div>
            </div>
    ...
    B["More (special) text"]`} blockId="pitfall-quotes" />
          ...
          <section>
            ...
            <div className="space-y-6">
              <div>
                <p className="mb-3 font-semibold" style={{ color: COLORS.accent.base }}>
                  Online Editors
                </p>
                <ul className="space-y-2 ml-6 list-disc" style={{ color: COLORS.text.secondary }}>
                  ...
                  <li className="leading-relaxed">
                    <strong style={{ color: COLORS.text.primary }}>Notion</strong> - Supports Mermaid code blocks
                  </li>
                </ul>
              </div>
